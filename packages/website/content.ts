...
export const PageContent = {
  hero: {
    ...
    description:
      'Barum is the most sophisticated project management tool in the world. It is the only tool that you will ever need to manage your projects.',
    cta: [
      {
      ...
      },
      {
        ...
        link: 'https://app.barum.com/sign-up',
        variant: 'filled',
      },
    ],
  },
  ...
  features01: {
    ...
    description: 'With Barum you can set enterprise-wide goals, manage strategic planning, and get work done on a single platform.',
    features: [
      {
  ...
  pricing01: {
    ...
    description: 'Use the advanced functionality of Barum. Start today. No credit card needed.',
    plans: [
      {
        planName: 'Free',
        planPrice: '0 EUR',
        ...
        ctaLink: 'https://app.barum.com/sign-up',
      },
      {
        planName: 'Pro',
        planPrice: '19 EUR',
  ...
  testimonials01: {
    title: 'Over 60,000 teams are leveraging the power that is happening with Barum',
    ...
    testimonials: [
      {
        ...
        content: 'Barum has been a game-changer for our team! It seamlessly organizes tasks and timelines, allowing us to collaborate effortlessly. Our productivity has skyrocketed since adopting this incredible app.',
      },
      {
        author: {
          name: 'John Doe',
        ...
        content: "I can't imagine managing projects without Barum now. It's intuitive, user-friendly, and has completely transformed the way we work. Highly recommended!",
      },
      {
        author: {
          name: 'John Doe',
        ...
        content: "Barum is pure magic for project managers. It simplifies complex workflows, and its real-time updates keep everyone on the same page. Our projects are running smoother than ever.",
      },
      {
        author: {
          name: 'John Doe',
        ...
        content: "As a small business owner, Barum has been a lifesaver. It's like having a virtual project manager. It's efficient, easy to use, and has boosted our team's overall performance.",
      },
      {
        author: {
          name: 'John Doe',
        ...
        content: "Barum has exceeded our expectations. It's not just a project management app; it's a strategic tool that has empowered us to meet deadlines and exceed client expectations consistently.",
      },
      {
        author: {
          name: 'John Doe',
        ...
        content: "We've tried several project management apps, and Barum stands out. Its customization options, coupled with its powerful features, have significantly improved our project planning and execution.",
      },
      {
        author: {
          name: 'John Doe',
        ...
        content: "Barum is the secret ingredient to our project success. Its collaborative features have brought our team closer, and the real-time updates ensure everyone is aligned and focused.",
      },
      {
        author: {
          name: 'John Doe',
        ...
        content: "In the fast-paced world of marketing, Barum keeps us ahead of the game. It's incredibly adaptive, making it easy to manage multiple campaigns simultaneously. A true gem for project management.",
      },
      {
        author: {
          name: 'John Doe',
        ...
        content: "Switching to Barum was a decision we'll never regret. The visual project timelines and intuitive interface make it easy to keep our team on track, resulting in consistently successful deliveries.",
      },
      {
        author: {
          name: 'John Doe',
        ...
        content: "Barum has made project management a breeze for our remote team. It's user-friendly, promotes accountability, and ensures that everyone stays connected, no matter where they are.",
      },
      {
        author: {
          name: 'John Doe',
        ...
        content: "We were drowning in spreadsheets before Barum came along. Now, our project data is organized, accessible, and presented in a visually appealing way. It's a project manager's dream.",
      },
      {
        author: {
          name: 'John Doe',
        ...
        content: "Barum doesn't just manage projects; it elevates them. Our project outcomes have become more predictable, deadlines are met with ease, and the stress of project management has become a thing of the past.",
      },
    ]
  },
  faq01: {
    ...
    faqs: [
      {
        title: "How can Barum benefit my team's collaboration?",
        content: 'Barum enhances collaboration by providing a centralized platform where team members can easily share updates, collaborate on tasks, and have real-time visibility into project progress.',
      },
      {
        title: "Is Barum suitable for small businesses with limited resources?",
        content: 'Absolutely! Barum is designed to be scalable and adaptable, making it an ideal choice for small businesses. It offers powerful project management features without overwhelming complexity.',
      },
      {
        title: "Can Barum integrate with other tools we are currently using?",
        content: 'Yes, Barum supports seamless integration with various third-party tools. This ensures that your team can continue using the tools they`re familiar with while leveraging the enhanced capabilities of Barum.',
      },
      {
        title: "How does Barum prioritize security for sensitive project data?",
        content: 'Security is a top priority for Barum. We employ industry-standard encryption protocols and robust security measures to safeguard your project data, ensuring confidentiality and integrity.',
      },
      {
        title: "Is there training required to use Barum effectively?",
        content: 'Barum is designed with user-friendliness in mind. While we provide resources for users to get started, the intuitive interface minimizes the learning curve. Most users find themselves comfortably navigating the app in no time.',
      },
  ...
  footer01: {
    brandclaim: 'Barum is the most sophisticated project management tool in the world. It is the only tool that you will ever need to manage your projects.',
    columns: [
      {
        title: 'Company',
        links: [
